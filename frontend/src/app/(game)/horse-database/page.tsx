  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-xs text-gray-500">
        {isLoading ? "Laddar…" : `${horses.length} hästar`}
        {search && ` (sök: "${search}")`}
      </div>
      ...
      <Card>
        {isLoading ? (
          <div className="text-gray-500 text-sm py-4">Laddar hästdatabas…</div>
        ) : horses.length === 0 ? (
          <div className="text-gray-500 text-sm py-4">Inga hästar hittades.</div>
        ) : (
